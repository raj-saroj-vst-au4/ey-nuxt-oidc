...
const faqs = ref<FAQ[]>([
  {
    id: 1,
    header:
      "I don't know anything – are there any prerequisites for the competition?",
  ...
  },
  {
    id: 3,
    header:
      "Is it necessary to form the team of 4 students before registration?",
    ...
    <div class="-mx-4 flex flex-wrap">
      <div class="w-full px-4">
        <div class="mx-auto mb-[60px] max-w-[520px] text-center lg:mb-20">
          <span class="mb-2 block text-lg font-semibold text-red-600">
            FAQ
          </span>
          <h2
          ...
          <p class="text-base text-body-color text-red-500">
    ...
    <div class="-mx-4 flex flex-wrap">
      <div class="w-full px-4 lg:w-1/2">
        <template :key="faq.id" v-for="faq in oddFaqs">
          <div
            class="mb-8 w-full rounded-lg p-4 bg-dark-2 shadow-[0px_20px_95px_0px_rgba(0,0,0,0.30)] sm:p-8 lg:px-6 xl:px-8"
          >
            <button
