<template>
  ...
  >
    <div
      class="flex flex-col justify-between h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800"
    >
      <div>
        <a
        ...
        <ul class="mt-2 space-y-2 font-medium">
          ...
          <li>
            <NuxtLink
              to="/"
              class="flex items-center p-2 text-gray-900 rounded-lg animate-pulse dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
            >
              <svg
                class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                aria-hidden="true"
              ...
              <span class="flex-1 ms-3 whitespace-nowrap">Apply for eLSI</span>
              <span
                class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300"
                >3</span
              >
      ...
      <div class="flex flex-row justify-between w-full px-4">
        ...
        <div class="text-xs text-white items-center">
          <p>
            {{ $oidc.user.name ?? "Loading..." }}
          </p>
          <p>
            {{ $oidc.user.email ?? "Loading..." }}
          </p>
        </div>
